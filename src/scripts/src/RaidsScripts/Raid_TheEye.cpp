...
class AstromancerAI : public ArcTicScriptCreatureAI
{
	ARCTIC_SCRIPT_FACTORY_FUNCTION(AstromancerAI, ArcTicScriptCreatureAI);
	AstromancerAI(Creature* pCreature) : ArcTicScriptCreatureAI(pCreature)
	{
		//spells
...
class VoidReaverAI : public ArcTicScriptBossAI
{
public:
	ARCTIC_SCRIPT_FACTORY_FUNCTION( VoidReaverAI, ArcTicScriptBossAI );
    VoidReaverAI( Creature* pCreature ) : ArcTicScriptBossAI( pCreature )
    {
...
void SpellFunc_Solarian_Disappear(SpellDesc* pThis, ArcTicScriptCreatureAI* pCreatureAI, Unit* pTarget, TargetType pType);
void SpellFunc_Solarian_Reappear(SpellDesc* pThis, ArcTicScriptCreatureAI* pCreatureAI, Unit* pTarget, TargetType pType);

class HighAstromancerSolarianAI : public ArcTicScriptBossAI
{
    ARCTIC_SCRIPT_FACTORY_FUNCTION(HighAstromancerSolarianAI, ArcTicScriptBossAI);
	HighAstromancerSolarianAI(Creature* pCreature) : ArcTicScriptBossAI(pCreature)
	{
		//Initialize timers
...
class SolariumAgentAI : public ArcTicScriptCreatureAI
{
    ARCTIC_SCRIPT_FACTORY_FUNCTION(SolariumAgentAI, ArcTicScriptCreatureAI);
    SolariumAgentAI(Creature* pCreature) : ArcTicScriptCreatureAI(pCreature)
    {
...
class SolariumPriestAI : public ArcTicScriptCreatureAI
{
	ARCTIC_SCRIPT_FACTORY_FUNCTION(SolariumPriestAI, ArcTicScriptCreatureAI);
	SolariumPriestAI(Creature* pCreature) : ArcTicScriptCreatureAI(pCreature)
	{
...
class SolariumSpotLight : public ArcTicScriptCreatureAI
{
	ARCTIC_SCRIPT_FACTORY_FUNCTION(SolariumSpotLight, ArcTicScriptCreatureAI);
	SolariumSpotLight(Creature* pCreature) : ArcTicScriptCreatureAI(pCreature){ SetCanEnterCombat(false); }
};
...
class DarkenerAI : public ArcTicScriptCreatureAI
{
public:
	ARCTIC_SCRIPT_FACTORY_FUNCTION(DarkenerAI, ArcTicScriptCreatureAI)
	DarkenerAI(Creature* pCreature) : ArcTicScriptCreatureAI(pCreature)
	{
...
class SanguinarAI : public ArcTicScriptCreatureAI
{
public:
	ARCTIC_SCRIPT_FACTORY_FUNCTION(SanguinarAI, ArcTicScriptCreatureAI)
	SanguinarAI(Creature* pCreature) : ArcTicScriptCreatureAI(pCreature)
	{
...
class CapernianAI : public ArcTicScriptCreatureAI
{
public:
	ARCTIC_SCRIPT_FACTORY_FUNCTION(CapernianAI, ArcTicScriptCreatureAI);
	CapernianAI(Creature* pCreature) : ArcTicScriptCreatureAI(pCreature)
	{
...
class TelonicusAI : public ArcTicScriptCreatureAI
{
public:
	ARCTIC_SCRIPT_FACTORY_FUNCTION(TelonicusAI, ArcTicScriptCreatureAI);
	TelonicusAI(Creature* pCreature) : ArcTicScriptCreatureAI(pCreature)
	{
...
class FlameStrikeAI : public ArcTicScriptCreatureAI
{
public:
	ARCTIC_SCRIPT_FACTORY_FUNCTION(FlameStrikeAI, ArcTicScriptCreatureAI);
	FlameStrikeAI(Creature* pCreature) : ArcTicScriptCreatureAI(pCreature)
	{
...
class PhoenixAI : public ArcTicScriptCreatureAI
{
public:
	ARCTIC_SCRIPT_FACTORY_FUNCTION(PhoenixAI, ArcTicScriptCreatureAI);
	PhoenixAI(Creature* pCreature) : ArcTicScriptCreatureAI(pCreature)
	{
...
class PhoenixEggAI : public ArcTicScriptCreatureAI
{
public:
	ARCTIC_SCRIPT_FACTORY_FUNCTION(PhoenixEggAI, ArcTicScriptCreatureAI);
	PhoenixEggAI(Creature* pCreature) : ArcTicScriptCreatureAI(pCreature)
	{
...
class WeaponsAI : public ArcTicScriptCreatureAI
{
public:
	ARCTIC_SCRIPT_FACTORY_FUNCTION(WeaponsAI, ArcTicScriptCreatureAI);
	WeaponsAI(Creature* pCreature) : ArcTicScriptCreatureAI(pCreature)
	{
...
void SpellFunc_KaelThasArcaneDisruption(SpellDesc* pThis, ArcTicScriptCreatureAI* pCreatureAI, Unit* pTarget, TargetType pType);
void SpellFunc_KaelThasFlameStrike(SpellDesc* pThis, ArcTicScriptCreatureAI* pCreatureAI, Unit* pTarget, TargetType pType);

class KaelThasAI : public ArcTicScriptBossAI
{
public:
	ARCTIC_SCRIPT_FACTORY_FUNCTION(KaelThasAI, ArcTicScriptBossAI);
	KaelThasAI(Creature* pCreature) : ArcTicScriptBossAI(pCreature)
	{
		for (int i = 1; i < 4; ++i)
		{
		...
		if (GetPhase() == 5)
		{
			...
			else if (IsTimerFinished(mEventTimer))
			{
				for (int i = 0; i < 4; ++i)
				{
					...
					ArcTicScriptCreatureAI *pAI = SpawnCreature(mAdvCoords[i].mAddition, mAdvCoords[i].mX, mAdvCoords[i].mY, mAdvCoords[i].mZ, false);
					if (pAI != NULL)
					{
					...
					if (pCreature != NULL)
					{
						...
						{
							static_cast<ArcTicScriptCreatureAI*>(pCreature->GetScript())->AggroNearestUnit(200);
						}
					}
				}
