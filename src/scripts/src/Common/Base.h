...
#define ARCTIC_SCRIPT_FACTORY_FUNCTION(ClassName, ParentClassName)\
public:\
...
typedef void(*SpellFunc)(SpellDesc* pThis, ArcTicScriptCreatureAI* pCreatureAI, Unit* pTarget, TargetType pType);
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//Class ArcTicScriptCreatureAI
class ArcTicScriptCreatureAI : public CreatureAIScript
{
public:
	ArcTicScriptCreatureAI(Creature* pCreature);
	virtual ~ArcTicScriptCreatureAI();

	//Movement
	bool					GetCanMove();
	void					SetCanMove(bool pCanMove);
	void					MoveTo(ArcTicScriptCreatureAI* pCreature, RangeStatusPair pRangeStatus = make_pair( RangeStatus_TooFar, 0.0f ) );
	...
	//Environment
	float					GetRange(ArcTicScriptCreatureAI* pCreature);
	...
	ArcTicScriptCreatureAI*	GetNearestCreature(uint32 pCreatureId=0);
	ArcTicScriptCreatureAI*	SpawnCreature(uint32 pCreatureId, bool pForceSameFaction=false);
	ArcTicScriptCreatureAI*	SpawnCreature(uint32 pCreatureId, float pX, float pY, float pZ, float pO=0, bool pForceSameFaction=false);
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//Class ArcTicScriptBossAI
class ArcTicScriptBossAI : public ArcTicScriptCreatureAI
{
public:
	ArcTicScriptBossAI(Creature *pCreature);
	virtual ~ArcTicScriptBossAI();
