...
#else
#define ARCTIC_INLINE inline
#endif

#define ARCTIC_FASTCALL __fastcall
...
ARCTIC_INLINE void reverse_array(uint8 * pointer, size_t count)
{
	size_t x;
...
ARCTIC_INLINE void ARCTIC_TOLOWER(std::string& str)
{
