...
#include "Common.h"
#include "DataStore.h"
#include "../shared/Utilities/Timer.h"
...
enum SUMMON_PROP_TYPE
{
    SUMMON_PROP_TYPE_NONE = 0,
    SUMMON_PROP_TYPE_PET = 1,
    SUMMON_PROP_TYPE_GUARDIAN = 2,
    SUMMON_PROP_TYPE_MINION = 3,
    SUMMON_PROP_TYPE_TOTEM = 4,
    SUMMON_PROP_TYPE_COMPANION = 5,
    SUMMON_PROP_TYPE_RUNEBLADE = 6,
    SUMMON_PROP_TYPE_CONSTRUCT = 7,
    SUMMON_PROP_TYPE_OPPONENT = 8,
    SUMMON_PROP_TYPE_VEHICLE = 9,
    SUMMON_PROP_TYPE_MOUNT = 10,
    SUMMON_PROP_TYPE_LIGHTWELL = 11,
    SUMMON_PROP_TYPE_BUTLER = 12
};
...
public:
	...
	ARCTIC_INLINE uint32 GetNumRows()
	{
		return m_numrows;
	}
