...
public:
	...
	void Perform();
	ARCTIC_INLINE void SetDB(Database * dbb) { db = dbb; }
};
...
public:
	...
	ARCTIC_INLINE const string& GetHostName() { return mHostname; }
	ARCTIC_INLINE const string& GetDatabaseName() { return mDatabaseName; }
	ARCTIC_INLINE const uint32 GetQueueSize() { return queries_queue.get_size(); }
...
public:
	...
	ARCTIC_INLINE Field* Fetch() { return mCurrentRow; }
	ARCTIC_INLINE uint32 GetFieldCount() const { return mFieldCount; }
	ARCTIC_INLINE uint32 GetRowCount() const { return mRowCount; }
