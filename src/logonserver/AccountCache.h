...
public:
	...
	ARCTIC_INLINE size_t GetCount() { return AccountDatabase.size(); }
...
public:
	ARCTIC_INLINE Mutex & getServerSocketLock() { return serverSocketLock; }
	ARCTIC_INLINE Mutex & getRealmLock() { return realmLock; }
