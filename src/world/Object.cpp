...
void Object::SetPhase(int32 phase)
{
	...
	m_phaseMode = phase;
	SendPhaseShift(uint8(m_phaseMode));
}
...
bool Object::PhasedCanInteract(Object* pObj)
{
	...
	if( pObj->m_phaseMode == m_phaseMode || pObj->m_phaseMode & m_phaseMode || m_phaseMode & pObj->m_phaseMode )
		return true;
