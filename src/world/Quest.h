...
public:
	...
	ARCTIC_INLINE uint32 GetPlayerSlainCount() { return m_player_slain; }
	ARCTIC_INLINE uint32 GetMobCount(uint32 i) { return m_mobcount[i]; }
	ARCTIC_INLINE uint32 GetExploredAreas(uint32 i) { return m_explored_areas[i]; }
	ARCTIC_INLINE uint32 GetTimeLeft() { return m_time_left; }
