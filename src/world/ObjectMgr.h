...
public:
	...
	ARCTIC_INLINE uint32 GetLeader() { return LeaderGuid; }
	ARCTIC_INLINE uint32 GetID() { return CharterId; }
...
public:
	...
	ARCTIC_INLINE bool IsSpellDisabled(uint32 spellid)
	{
	...
	ARCTIC_INLINE GuildMap::iterator GetGuildsBegin() { return mGuild.begin(); }
	ARCTIC_INLINE GuildMap::iterator GetGuildsEnd() { return mGuild.end(); }
