...
struct FactionReputation
{
	...
	uint8 flag;
	int32 baseStanding;
	ARCTIC_INLINE int32 CalcStanding() { return standing - baseStanding; }
	ARCTIC_INLINE bool Positive() { return standing >= 0; }
};
...
public:
	...
	ARCTIC_INLINE std::string* GetNameString() { return &m_name; }
	...
	ARCTIC_INLINE QuestLogEntry*GetQuestLogInSlot(uint32 slot){ return m_questlog[slot]; }
	ARCTIC_INLINE uint32 GetQuestSharer(){ return m_questSharer; }
	...
	ARCTIC_INLINE void SetTeam(uint32 t) { m_team = t; m_bgTeam=t; }
	ARCTIC_INLINE void ResetTeam() { m_team = myRace->team_id==7 ? 0 : 1; m_bgTeam=m_team; }

	ARCTIC_INLINE bool IsInFeralForm()
	{
		int s = GetShapeShift();
		if( s <= 0 )
			return false;
    ...
    /* PVP                                                                  */
    /************************************************************************/
	ARCTIC_INLINE uint8 GetPVPRank()
	{
		return (uint8)((GetUInt32Value(PLAYER_BYTES_3) >> 24) & 0xFF);
	}
	ARCTIC_INLINE void SetPVPRank(int newrank)
	{
	...
	ARCTIC_INLINE float GetBlockFromSpell() { return m_blockfromspell; }
	ARCTIC_INLINE float GetSpellCritFromSpell() { return m_spellcritfromspell; }
	ARCTIC_INLINE float GetHitFromMeleeSpell() { return m_hitfrommeleespell; }
	...
	ARCTIC_INLINE bool IsVisible(Object* pObj) { return !(m_visibleObjects.find(pObj) == m_visibleObjects.end()); }
	void AddInRangeObject(Object* pObj);
	void OnRemoveInRangeObject(Object* pObj);
	void ClearInRangeSet();
	ARCTIC_INLINE void AddVisibleObject(Object* pObj) { m_visibleObjects.insert(pObj); }
	ARCTIC_INLINE void RemoveVisibleObject(Object* pObj) { m_visibleObjects.erase(pObj); }
	ARCTIC_INLINE void RemoveVisibleObject(InRangeSet::iterator itr) { m_visibleObjects.erase(itr); }
	ARCTIC_INLINE InRangeSet::iterator FindVisible(Object* obj) { return m_visibleObjects.find(obj); }
	ARCTIC_INLINE void RemoveIfVisible(Object* obj)
	{
	...
	ARCTIC_INLINE bool GetVisibility(Object* obj, InRangeSet::iterator *itr)
	{
	...
	ARCTIC_INLINE float res_R_crit_get(){return m_resist_critical[1];}
	ARCTIC_INLINE void res_R_crit_set(float newvalue){m_resist_critical[1]=newvalue;}
    ...
    ARCTIC_INLINE uint32 GetSoulStoneReceiver(){return SoulStoneReceiver;}
    ARCTIC_INLINE void SetSoulStoneReceiver(uint32 StoneGUID){SoulStoneReceiver = StoneGUID;}
    ARCTIC_INLINE uint32 GetSoulStone(){return SoulStone;}
    ARCTIC_INLINE void SetSoulStone(uint32 StoneID){SoulStone = StoneID;}
	...
	ARCTIC_INLINE void setMyCorpse(Corpse* corpse) { myCorpse = corpse; }
	ARCTIC_INLINE Corpse* getMyCorpse() { return myCorpse; }
	...
	/* Last Speeds */
	ARCTIC_INLINE void UpdateLastSpeeds()
	{
	...
	ARCTIC_INLINE bool IsAttacking() {return m_attacking; }
