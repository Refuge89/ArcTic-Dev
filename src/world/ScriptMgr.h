...
enum ServerHookEvents
{
	...
	SERVER_HOOK_EVENT_ON_DESTROY_BUILDING	= 33,
	SERVER_HOOK_EVENT_ON_DAMAGE_BUILDING	= 34,
	SERVER_HOOK_EVENT_ON_CONTINENT_CREATE	= 35,
	SERVER_HOOK_EVENT_ON_PLAYER_SAVE_TO_DB	= 36,
	SERVER_HOOK_EVENT_ON_POST_SPELL_CAST	= 37,
	SERVER_HOOK_EVENT_ON_SLOW_LOCK_OPEN		= 38,
...
typedef HM_NAMESPACE::hash_map<uint32, GossipScript*> GossipMap;
