...
public:
	...
	ARCTIC_INLINE void AquireInrangeLock(){ m_inrangechangelock.Acquire(); }
	ARCTIC_INLINE void ReleaseInrangeLock(){ m_inrangechangelock.Release(); }

	//m_sameFactsInRange
	ARCTIC_INLINE void AquireSameFacInRangeLock(){ m_samefactsinrangechangelock.Acquire(); }		
	ARCTIC_INLINE void ReleaseSameFacInRangeLock(){ m_samefactsinrangechangelock.Release(); }

	//m_inrangeplayerchangelock
	ARCTIC_INLINE void AquirePlayerInRangeLock(){ m_inrangeplayerchangelock.Acquire(); }		
	ARCTIC_INLINE void ReleasePlayerInRangeLock(){ m_inrangeplayerchangelock.Release(); }
...
//	bool HasPhase() { return m_phase != 0; }
	bool IsInPhase(int32 phaseMode){ if(AllPhases) return true; return ((m_phaseMode & phaseMode) != 0); }
...
//	int32 m_phaseMode;
	...
	//inrange Lock protected
	Mutex m_inrangechangelock;
	//m_samefactinrangelock
	Mutex m_samefactsinrangechangelock;
	//m_inrangeplayerchangelock
	Mutex m_inrangeplayerchangelock;
